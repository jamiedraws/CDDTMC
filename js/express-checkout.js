    ...
    if ("app" in global) {
        ...
        expressCheckout.addProperties({
            ...
            processTask: function () {
                ...
                this.handleOptions();
                this.initializeCallToActionDisclaimerView();
            },
            initializeCallToActionDisclaimerView: function () {
                const cardOption = this.options.find((option) =>
                    option.querySelector("#otCARD[checked]")
                );
            ...
            hideCallToAction: function () {
                this.callToAction.classList.add("form__is-hidden");
            },
            showCallToAction: function () {
                this.callToAction.classList.remove("form__is-hidden");
            },
