...
<asp:Content ID="Content0" ContentPlaceHolderID="preload" runat="server">
	<link rel="preload" href="/css/Site2/form.css" as="style"/>
</asp:Content>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	<link rel="stylesheet" href="/css/Site2/form.css"/>
												...
												<div class="form__field-label">
													<div class="form form--select">
														<div class="form__contain">
															...
															<select name="quantitySelection" id="quantitySelection" class="form__field" required>
													...
													<a href="javascript:void(0);" data-code-toggle="true" data-code="TMJ" data-select-id="quantitySelection" class="form__button button" type="button">
