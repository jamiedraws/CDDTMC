...
<link rel="stylesheet" href="/css/Site2/app.css<%= v %>" />

<% if (!isStartPage) { %>
    <link rel="stylesheet" href="/css/Site2/form.css<%= v %>" />
<% } %>

<% if (isStartPage) { %>
    <link rel="stylesheet" href="/css/Site2/page.css<%= v %>" />
<% } %>
...
<script defer src="/js/Site2/app.es5.js"></script>