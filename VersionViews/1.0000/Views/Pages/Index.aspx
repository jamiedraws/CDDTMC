	...
	<div class="view__in main-offer__in section__in">
		<div class="main-offer__group">
			...
			<picture class="main-offer__picture">
				<source srcset="/images/1.0000/offer.webp" type="image/webp">
			...
			<div class="view main-offer__video">
				<div class="view__anchor" id="video"></div>
				<div data-src-iframe="https://player.vimeo.com/video/672496746?muted=1" data-attr='{ "width" : "677", "height" : "381", "title" : "Commercial", "allow" : "fullscreen" }' class="contain contain--video"></div>
				<p class="main-offer__video-title">This offer is not available in stores!</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="view__in content__in section__in">
		<div class="content__group">
			<div class="content__picture">
				<picture>
					<source srcset="/images/1.0000/naked-man-wo-shadow.webp" type="image/webp">
	...
	<div class="view__in content__in section__in">
		<div class="content__group">
			<figure class="content__picture picture-card-caption">
				<picture>
					<source srcset="/images/1.0000/naked-man-w-sign.webp" type="image/webp">
					...
					<div class="slide__item">
						<figure class="content__figure">
							...
							<blockquote class="content__text">
								<p>&ldquo;LOVE IT! Every man needs these essentials!!&rdquo;</p>
							</blockquote>
							<figcaption class="content__caption">Louis</figcaption>
						</figure>	
					</div>
					<div class="slide__item">
						<figure class="content__figure">
							...
							<blockquote class="content__text">
								<p>&ldquo;Trojan Man Care is a must buy for every man. It not only smells AMAZING, like truly it smells like the best cologne I've ever smelled, but it is super effective as well. Nothing is more of a mood killer than someone who doesn't know how to practice effective personal hygiene. If you are a man with balls, RUN don't walk to buy these products and then thank Trojan for your thriving love life.&rdquo;</p>
							</blockquote>
							<figcaption class="content__caption">Cassidy</figcaption>
						</figure>	
					</div>
					<div class="slide__item">
						<figure class="content__figure">
							...
							<blockquote class="content__text">
								<p>&ldquo;I would highly recommend this bundle to people needing to incorporate some extra steps to their care routine.. especially now with all this summer heat!&rdquo;</p>
							</blockquote>
							<figcaption class="content__caption">Chris</figcaption>
						</figure>	
					</div>
					<div class="slide__item">
						<figure class="content__figure">
							...
							<blockquote class="content__text">
								<p>&ldquo;My girlfriend and I always had a good sex life, but ever since I started joking about giving her the "cool woods" scent &ndash; it always seems to put her in the mood!&rdquo;</p>
							</blockquote>
							<figcaption class="content__caption">Jake</figcaption>
						</figure>	
					</div>
					<div class="slide__item">
						<figure class="content__figure">
